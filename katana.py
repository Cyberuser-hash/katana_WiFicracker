...
|                                                               |                                                                        
+===============================================================+==========================================================================
[                      \033[32m ОСНОВНОЕ МЕНЮ\033[0m \033[31m                          ]
+===============================================================+\033[0m''')
...
|                                                               |
+===============================================================+==========================================================================
[                      \033[32m ОСНОВНОЕ МЕНЮ\033[0m \033[31m                          ] Адаптер: {adapter_name} 
+===============================================================+\033[0m''')
...
#================================================================
def scanner():
    os.system(f'sudo xterm -e "airodump-ng -w networks --output-format csv {adapter_name}"')
